...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Vérifiez si le nom du nomGenre est vide
    if (empty($nomnomGenre)) {
        $_SESSION['error'] = "Le nom du nomGenre ne peut pas être vide.";
    ...
    try {
        ...
        if ($statementCheck->rowCount() > 0) {
            ...
            $query = "INSERT INTO SPORT (nom_sport) VALUES (:nomGenre)";
...
<body>
    ...
    <main>
        ...
        <form action="add-gender.php" method="post"
            ...
            <input type="text" name="nomGebre" id="nomGenre" required>
